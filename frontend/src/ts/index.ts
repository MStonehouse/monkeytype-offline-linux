...
if (accepted === null) {
  // Offline desktop edition: no web cookie consent is required.
  // Keep analytics and Sentry disabled while retaining the local security state.
  Cookies.setAcceptedCookies({
    security: true,
    analytics: false,
    sentry: false,
  });
